...
describe('Valid Hmong words', function() {
    ...
    describe('hmong green words', function() {
        it('valid word - "NOM"', function() {
            hmongspellchecker.check('NOM', function(result) {
                result.should.equal(true);
            });
        });

        it('valid word - "tsuv"', function() {
            hmongspellchecker.check('tsuv', function(result) {
                result.should.equal(true);
            });
        });

        it('valid word - "tUm"', function() {
            hmongspellchecker.check('tUm', function(result) {
                result.should.equal(true);
            });
        });
    });
